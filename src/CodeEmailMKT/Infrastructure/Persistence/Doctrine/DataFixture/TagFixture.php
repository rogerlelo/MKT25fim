...
class TagFixture extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface
{
    ...
    {
        $indexesCustomers = array_rand(range(0,1), 2);//$indexesCustomers = array_rand(rand(0,4), rand(2,5));
    ...
    {
        $indexesCampaigns = array_rand(range(0,19), rand(2,5));//$indexesCampaigns = array_rand(rand(0,19), rand(2,5));
